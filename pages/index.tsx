...
//Libraries
import { auth, checkUserDataExists, getUserData, getClassFromReference } from "../firebase"
      ...
      if (user) {
        (async () => {
          ...
          if (userExists) { //ログインされている状態でユーザー情報の登録まで済んでいる
            ...
            const classData = await getClassFromReference(res.class)
            ...
            setUserdata({
              ...
              className: classData.screenName
            })
