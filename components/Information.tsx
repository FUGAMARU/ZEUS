		...
		<Box mx={2} overflowX="hidden">
			<VStack align="stretch" divider={<StackDivider borderColor="gray.200"/>} overflowY="auto" maxH={{base: 400, md:460, lg: 500}}>
				...
				<Box onClick={() => {
					...
					<ThreadListHeading title="基本情報等検定試験申込報告" lastUpdate="1分以内"/> {/*1分以内、○分前、○時間前、○日前、○ヶ月前、1年以上前*/}
				</Box>
				...
				<Box onClick={() => {
					...
					<ThreadListHeading title="個人面談及び模擬面接スケジュール（2/15～17の模擬面接欠席者）" lastUpdate="1分以内"/> {/*1分以内、○分前、○時間前、○日前、○ヶ月前、1年以上前*/}
				</Box>
				...
				<Box onClick={() => {
					...
					<ThreadListHeading title="卒業展2022　ITカレッジサイト" lastUpdate="1分以内"/> {/*1分以内、○分前、○時間前、○日前、○ヶ月前、1年以上前*/}
				</Box>
				...
				<Box onClick={() => {
					...
					<ThreadListHeading title="在校生のみなさまへ" lastUpdate="1分以内"/> {/*1分以内、○分前、○時間前、○日前、○ヶ月前、1年以上前*/}
				</Box>
				...
				<Box onClick={() => {
					...
					<ThreadListHeading title="e-FESTA登録料　及び　第４回基本情報技術者試験　午前免除試験料　の返金に関して" lastUpdate="1分以内"/> {/*1分以内、○分前、○時間前、○日前、○ヶ月前、1年以上前*/}
				</Box>
				...
				<Box onClick={() => {
					...
					<ThreadListHeading title="１月１７日（月）以降の時間割" lastUpdate="1分以内"/> {/*1分以内、○分前、○時間前、○日前、○ヶ月前、1年以上前*/}
				</Box>
				...
				<Box onClick={() => {
					...
					<ThreadListHeading title="＜健康診断についての詳細＞" lastUpdate="1分以内"/> {/*1分以内、○分前、○時間前、○日前、○ヶ月前、1年以上前*/}
				</Box>
				...
				<Box onClick={() => {
					...
					<ThreadListHeading title="＜健康診断日程が確定しました＞" lastUpdate="1分以内"/> {/*1分以内、○分前、○時間前、○日前、○ヶ月前、1年以上前*/}
				</Box>
